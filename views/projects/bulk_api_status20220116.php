        ...
        <div id="page-content-wrapper">
          <div id="page-content">
            <div class="container">
              ...
              <div id="page-title">
                <h2 class="pad10B"><strong>MAKE PROJECTS PUBLIC</strong></h2>
                <h5 class="pad10B">&nbsp;</h5>
              </div><!--Page Title-->
                ...
                <div class="panel-body">
                  ...
                  <div class="example-box-wrapper">
                    ...
                    <div class="content-box">
                      ...
                      <div class="example-box-wrapper">
                        <form method="post" action="index.php?q=projects/bulk_api_status" class="form-horizontal bordered-row" />
                          <div class="form-group">
                            <label class="col-sm-3 control-label">
                              Choose Projects that should be Public
                            </label>
                            <div class="col-sm-6">
